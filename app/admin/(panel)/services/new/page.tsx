...
export default async function NewServicePage() {
  ...
  return (
    <div className="p-8 animate-fade-in">
      ...
      <h1 className="font-display font-bold text-xl text-navy dark:text-white mb-1">Create New Service</h1>
      <p className="text-sm text-gray-400 mb-8">Add a new government service with steps and requirements.</p>
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-white/[0.07] p-6 animate-fade-in-up animation-delay-100">
