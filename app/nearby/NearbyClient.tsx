  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="animate-fade-in-up">
        <p className="text-sm text-gray-400 dark:text-gray-500 mb-8 flex items-center gap-1.5">
        ...
        {agencies.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {agencies.map((agency, i) => (
              <a
                ...
                className="group bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-white/10 p-5 hover:border-gold/40 dark:hover:border-gold/30 hover:shadow-md hover:shadow-navy/[0.04] dark:hover:shadow-black/20 hover:-translate-y-0.5 transition-all duration-300 animate-fade-in-up"
              ...
              >
                ...
                <div className="pt-3 border-t border-gray-50 dark:border-white/5 flex items-center gap-1.5 text-xs font-medium text-gold group-hover:text-gold/80 transition-colors">
          ...
          <EmptyState
            ...
            description="There are no agencies to display right now."
            icon={<MapPin className="w-7 h-7 text-gray-300 dark:text-gray-600" />}
          />
        )}
      </div>
    </div>
