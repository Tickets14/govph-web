...
export default async function HomePage() {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative bg-navy overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 text-center">
          ...
          <h1 className="font-display font-extrabold text-white leading-[1.08] animate-fade-in-up animation-delay-100">
            <span className="block text-4xl sm:text-5xl lg:text-[58px]">Know the requirements.</span>
      ...
      <section className="py-20 bg-white dark:bg-gray-950">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-10 animate-fade-in-up">
            <div>
              <p className="text-[11px] font-semibold text-gold uppercase tracking-widest mb-2">Most Popular</p>
              <h2 className="font-display font-bold text-2xl sm:text-3xl text-navy dark:text-white">
                Government Services
              </h2>
            </div>
            <Link
      ...
      <section className="py-20 bg-[#f7f8fa] dark:bg-gray-900/50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14 animate-fade-in-up">
            ...
            <h2 className="font-display font-bold text-2xl sm:text-3xl text-navy dark:text-white">3 Simple Steps</h2>
            <p className="mt-2 text-sm text-gray-400 dark:text-gray-500 max-w-xs mx-auto">
              No confusion. Just follow the process.
            </p>
          </div>
            ...
            {[
              {
                ...
                icon: Search,
                title: 'Search',
                description: 'Type the service you need — passport, clearance, license, and more.',
              },
              {
                step: '02',
                icon: List,
                title: 'View the Checklist',
                description: 'See the full list of requirements, fees, and steps clearly laid out.',
              },
              {
                step: '03',
                icon: Trophy,
                title: 'Complete It!',
                description: 'Check off each step as you work through your transaction.',
              },
      ...
      {/* ── Agencies Row ──────────────────────────────────── */}
      <section className="py-20 bg-white dark:bg-gray-950 border-t border-gray-100 dark:border-white/10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-10 animate-fade-in-up">
            <div>
              <p className="text-[11px] font-semibold text-gold uppercase tracking-widest mb-2">Covered Agencies</p>
              <h2 className="font-display font-bold text-2xl text-navy dark:text-white">Government Agencies</h2>
            </div>
            <Link
              href="/agencies"
              className="hidden sm:flex items-center gap-1.5 text-sm font-medium text-gray-400 hover:text-navy transition-colors duration-200"
