...
export function FeedbackActions({ id, subject }: FeedbackActionsProps) {
  ...
  const handleDelete = async () => {
    ...
    const res = await adminClientFetch(`/api/admin/feedbacks/${id}`, { method: 'DELETE' });
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-400 mt-1 leading-relaxed">
                    ...
                    <span className="font-medium text-gray-600 dark:text-gray-300">&ldquo;{subject}&rdquo;</span>? This
