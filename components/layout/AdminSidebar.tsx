...
import { LayoutDashboard, FileText, Building2, Shield, ArrowLeft, LogOut } from 'lucide-react';
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active ? 'bg-gold text-navy' : 'text-blue-200 hover:bg-white/10 hover:text-white'
              )}
            >
