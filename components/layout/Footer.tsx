...
export function Footer() {
  return (
    <footer className="bg-gradient-to-b from-navy to-navy-dark dark:from-gray-900 dark:to-gray-950 text-white mt-auto relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              <div className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center">
                <ClipboardCheck className="w-4.5 h-4.5 text-gold" />
              </div>
          ...
          {/* Resources */}
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-widest text-white/40 mb-4">Resources</h3>
            <ul className="space-y-2.5">
              {[
                { href: '/nearby', label: 'Nearby Offices' },
                { href: '/saved', label: 'Saved Services' },
              ].map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
          ...
          {/* Disclaimer */}
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-widest text-white/40 mb-4">Disclaimer</h3>
        ...
        <div className="border-t border-white/[0.06] mt-10 pt-7 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-white/35">
            &copy; {new Date().getFullYear()} Gov Requirements Tracker. For the Filipino people.
          </p>
